...
In addition, you will also need the earliest date of continuous ownership of the security (entered in S6 / Part 1) — this is the date of the first purchase that contributed to the current pooled position, tracked in your ACB spreadsheet; see [Adjusted-Cost-Base-Tracking.md](Adjusted-Cost-Base-Tracking.md)
