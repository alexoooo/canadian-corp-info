...
- Box 21: Proceeds of disposition or settlement amount
  ...
  - If you see the gross amount (and the trade confirmation has a commission), subtract the commission — it belongs in Schedule 6 as "Outlays and expenses from disposition", not folded into Box 21
...
When you sell an investment, you will need to report it in "Schedule 6 (S6) - Summary of Dispositions of Capital Property" of the T2 (in addition to the above ledger entries).  
Report the ACB from your own records — do not use T5008 Box 20 (cost or book value), which may differ from your true ACB.  
If a disposition occurred but no T5008 was received (rare, but possible), report the sale on Schedule 6 (S6) using your own trade records and independently calculated ACB.  
