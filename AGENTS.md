...
- **`guide/Filing-And-CRA/Payment/Payment.md`** — the corporate-tax payment workflow: balance-due day, instalments and their bases, payment methods, and the GST/HST and payroll remittance cadence
...
- **`guide/Sole-Proprietorship/Sole-Proprietorship.md`** — hub for the sole-proprietorship side group (the unincorporated contractor); kept to the delta from the corporate pages
- **`guide/Personal-Tax/Personal-Tax.md`** — hub for the personal-tax side group (the owner's own T1 in basic common situations); kept to the situations, with brackets, employment income at large, and benefits out of scope
...
- **Workflow evidence**: base operational instructions and templates on verified sources, exercised workflows, or explicit maintainer decisions; do not invent an untested process and present it as established guidance; an AI-review status marker does not substitute for that evidence
