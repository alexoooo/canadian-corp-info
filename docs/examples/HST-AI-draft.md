...
> Curated excerpt of [`../../guide/HST.md`](../../guide/HST.md) as drafted (AI generated); snapshot 2026-06-23.
> Read it against a reviewed page and the rules in [`../Style-Guide.md`](../Style-Guide.md#reviewing-an-ai-draft).

Tells on display:
- Dense multi-clause bullets that pack several facts where the reviewed style keeps one fact per bullet
- Long compound sentences carrying multiple clauses and stacked parentheticals
- Narrative, verb-led sentence openers where a colon lead-in would do

The scaffolding (headings, colon lead-ins, citations) is already right.  
What review changes is the prose.  
