...
- Sole-proprietor treatment appears only as a brief contrast for comparison; unincorporated businesses and personal T1 mechanics are otherwise out of scope (see [Small Business Tax Overview](Small-Business-Tax-Overview.md))
...
- In a 13% HST province: $7,670 × 13/113 ≈ $882; book the ITC to `HST receivable` and net it out of the expense (see [HST](HST.md))
...
- Deductible at 50% under ITA [s.67.1](https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-67.html); the matching 50% ITC limit is in ETA s.236 (see [HST](HST.md))
