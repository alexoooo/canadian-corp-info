...
- Amounts owed by the owner are the shareholder-loan regime, not bad-debt territory; see [Owner-corporation transactions](Owner-Corporation-Transactions.md#shareholder-loans)
...
- The continuity (opening, closing) is reported on T2 Schedule 13 (see [T2 Schedules](T2-Schedules.md#event-driven-schedules))
...
- [Owner-corporation transactions](Owner-Corporation-Transactions.md) (amounts owed by the owner)
