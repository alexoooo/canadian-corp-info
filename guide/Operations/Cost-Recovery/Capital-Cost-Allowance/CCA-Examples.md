...
**Who this is for**:
- Owners of a Canadian-controlled private corporation (CCPC) who want end-to-end CCA walkthroughs
  - With ledger entries and the matching T2 schedules
...
For the underlying rules see [Capital Cost Allowance](Capital-Cost-Allowance.md).  
For which class an asset goes in see [CCA Classification](CCA-Classification.md).  
For the per-row spreadsheet formulas see [CCA Tracking](CCA-Tracking.md).  
...
Buys a laptop for $4,520 (including 13% HST) on Mar 1 2026.  
The corp is HST-registered and claims the $520 ITC; capitalizes the $4,000 net to Class 50.  
...
- Standalone application software (e.g. a $200 perpetual licence for an IDE) → Class 12 (100%)
  - Application software is subject to the half-year rule, halving the first-year claim outside the AIIP window
  - The reinstated AIIP suspends it for a 2026 acquisition
- SaaS subscriptions (Office 365, AWS, Claude) → operating expense, GIFI 9150 Computer-related expenses
...
- Class 50 computer equipment qualifies for 100% first-year expensing under the Budget 2024 productivity measure
  - Property acquired after Apr 15 2024 and available for use before 2027
  - So the maximum first-year CCA is 100% × $4,000 = $4,000
  - The general AIIP result would be lower (150% × $4,000 × 55% = $3,300), so the 100% measure governs
- Closing UCC: $4,000 − $4,000 CCA = $0
- CCA is a ceiling, not a mandate: the corp may claim any amount from $0 to $4,000
  - Any unclaimed cost stays in UCC to depreciate at 55% later
...
- If the laptop was the only Class 50 asset and the resulting balance is positive
  - Claim the residual as a *terminal loss* (ITA s.20(16))
...
Buys a $1,800 floor polisher on Jun 15 2026.  
The corp is HST-registered and claims the $234 ITC; capitalizes $1,800 to Class 8.  
...
- Under the reinstated AIIP, the first-year deduction is $1,800 × 1.5 × 20% = $540 and closing UCC is $1,260
  - The multi-year tail below is shown on the pre-AIIP $1,620 basis to illustrate the declining-balance mechanics
...
When to trigger a terminal loss: disposing of every piece of Class 8 property in the year.  
The residual UCC then becomes a deduction (ITA s.20(16)).  
For a multi-asset pool, this is rarely useful.  
For a single-asset class that has been sold or scrapped, it cleans up the pool.  


## Example 3: Class 14.1 Incorporation Expenses

Setup: corp is incorporated on Apr 1 2026 (first fiscal year Apr 1 2026 to Mar 31 2027).  
Total cost is $4,200 in incorporation expenses (legal fees, name search, registry filing, minute book).  
...
- Under the reinstated AIIP (available for use before 2030), the half-year rule is suspended
  - The first-year base is 150% of the addition: CCA of $1,800 × 5% = $90 (three times the half-year figure)
- Closing UCC: $1,200 − $90 = $1,110

Short fiscal year: this first fiscal year is exactly 365 days, so no proration.  
(Apr 1 2026 to Mar 31 2027 is a non-leap-year alignment.)  
If incorporation had been Oct 1 2026 with a Mar 31 2027 year-end, the first fiscal year would be 182 days.  
CCA would then be prorated under Regulation 1100(3): $90 × (182 / 365) ≈ $44.88.  
...
Incorporation expenses under $3,000: the entire amount is immediately deductible in year 1.  
...
Builds a small wooden dock on poles over April 2026 for $6,780 (including 13% HST), available for use May 1 2026.  
The corp is HST-registered and claims the $780 ITC; capitalizes the $6,000 net to Class 3.  
Small fishing boats and pontoons tie up to it.  
It is not a loading wharf, so it is a *dock* (Class 3, 5%), not a wooden wharf (Class 6, 10%).  
See [Example 1: Small wooden dock](CCA-Classification.md#example-1-small-wooden-dock) for that classification call.  
While the dock is being built the costs sit in construction-in-progress and are not yet depreciable.  
They move to Class 3 and start CCA only when it is available for use (see [Materials and CIP](../Materials-And-CIP.md)).  
...
- Under the reinstated AIIP (available for use before 2030), the half-year rule is suspended
  - The first-year base is 150% of the addition: CCA of $9,000 × 5% = $450 (three times the half-year figure)
...
- A 5% pool decays very slowly: by year 20 roughly $2,100 of the $6,000 still sits in the pool
  - A dock stays on Schedule 8 for decades

Disposal: a dock is usually removed or scrapped rather than sold.
- With no other Class 3 property left when the dock is removed, the remaining UCC is a *terminal loss* (ITA s.20(16))
- If a storm or ice destroys it and insurance pays out, part may be *recapture* (ITA s.13(1))
  - Proceeds (capped at the $6,000 cost) above the then-current UCC are recapture
  - Any insurance above $6,000 is a capital gain on Schedule 6, not recapture
...
- Income Tax Regulations (C.R.C., c. 945): https://laws-lois.justice.gc.ca/eng/regulations/C.R.C.,_c._945/
  - Regulation 1100(2) half-year rule; Regulation 1100(3) short-fiscal-year proration
