...
- Principal-residence and personal-use angles of corporately-held property (owner living in it) are shareholder-benefit territory; see [Owner-corporation transactions](../Paying-Yourself/Owner-Corporation-Transactions.md)
...
- *Income from property*: 50.2%, of which 30⅔% is refundable through [NERDTOH](../Paying-Yourself/Dividends/ERDTOH-NERDTOH.md) when non-eligible dividends are paid — integration, but with cash locked up until then
