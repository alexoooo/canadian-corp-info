...
**Who this is for**:
- Owners of a Canadian-controlled private corporation (CCPC) who have read the worked topics
  - Wanting a map of what sits just outside them
- Looking for the nearest pointer on a topic this guide does not work through end to end
  - The pointer can be another page here, a CRA form, or an ITA section

**TLDR**:
- This guide works a defined slice: the bookkeeping and tax of an owner-managed CCPC doing its own books
- Some adjacent topics are mentioned in passing but not developed
- A few are relevant but absent, and others are deliberately left out
...
- Scope decisions reflect a typical single-owner consulting or investing CCPC
  - A different corp may pull one of the out-of-scope topics into relevance
...
- *Multi-employee HR and payroll*: [Payroll](../Paying-Yourself/Payroll.md) works the single owner-manager case
...
- Spun off from the 2026-07-01 Coverage Review to hold its still-open leftovers beyond the dated audit
