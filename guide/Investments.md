...
| Funding | investment income is taxed differently from active income, and too much of it can grind the small business deduction | [Active vs investment income](Small-Business-Tax-Overview.md#active-vs-investment-income), [Tax Integration](Tax-Integration.md) |
...
| Buying in USD | convert every amount to CAD at the transaction-date rate | [Foreign Currency](Foreign-Currency.md) |
...
| Pools | the tax-free half of capital gains accumulates in the CDA; refundable tax accumulates in ERDTOH and NERDTOH | [Capital Dividend Account](Capital-Dividend-Account/Capital-Dividend-Account.md), [ERDTOH and NERDTOH](Dividends/ERDTOH-NERDTOH.md) |
| Paying out | capital dividends come out tax-free (with an election); taxable dividends recover the refundable tax | [Dividends](Dividends/Dividends.md) |
| T2 reporting | S3, S6, S7, S21, and S55 carry the investment activity onto the return | [T2 Schedules — Investment-income schedules](T2-Schedules.md#investment-income-schedules) |


## Related

- [Small-Business-Tax-Overview](Small-Business-Tax-Overview.md)
- [Concept map](Concept-Map.md) (the same territory as a single diagram)
- [T2 Schedules](T2-Schedules.md) (where each slip lands on the return)
- [Losses](Losses.md) (capital losses from the portfolio and their carryover)
- [Owner-corporation transactions](Owner-Corporation-Transactions.md) (moving money between you and the corporation)
...
- If the investment pages ever move into a `guide/Investments/` folder, this page becomes the folder hub
