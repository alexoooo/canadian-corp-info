...
Limitations:
- This page defines the vocabulary; the tax mechanics of redemptions and deemed dividends live in [Dividends](../../Paying-Yourself/Dividends/Dividends.md), and restructuring is in [Business Acquisition](../Business-Acquisition/Business-Acquisition.md)
...
- A distribution above PUC is a *deemed dividend*: a reduction of PUC under ITA s.84(4), or redemption proceeds over PUC under ITA s.84(3) (see [Dividends — Deemed dividends](../../Paying-Yourself/Dividends/Dividends.md#deemed-dividends))
...
- *Different dividend entitlements*: a separate class can receive a dividend independent of the common, which supports paying co-owners different amounts (caught by TOSI for family members not active in the business; see [Dividends — Multiple owner-managers](../../Paying-Yourself/Dividends/Dividends.md#multiple-owner-managers) and [TOSI](../../Paying-Yourself/Dividends/Dividends.md#tax-on-split-income-tosi))
