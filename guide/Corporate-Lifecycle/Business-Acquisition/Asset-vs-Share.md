...
**TLDR**:
- *Asset purchase*: buy selected assets and assume chosen liabilities; the buyer gets a fresh cost base and avoids unknown liabilities
- *Share purchase*: buy the company itself; the buyer inherits its tax pools, contracts, and latent liabilities
- The vendor usually prefers a *share* sale (capital gain, possible lifetime capital gains exemption); the buyer usually prefers an *asset* sale (cost step-up, clean liabilities)
- If the target is not incorporated, only an asset purchase is possible

Limitations:
- Orientation only; the allocation of price across assets, and the QSBC tests for the exemption, need professional advice
- Tax figures (the lifetime capital gains exemption limit, the capital gains inclusion rate) are 2026 amounts and change; verify before relying on them
...
- Depreciable assets start fresh CCA pools at their allocated cost, so the buyer depreciates the full price paid (see [Capital Cost Allowance](../../Operations/Cost-Recovery/Capital-Cost-Allowance/Capital-Cost-Allowance.md))
...
- *Incorporated target*: both structures are open, and the vendor and buyer want opposite ones; the final structure and price are negotiated, often with the price reflecting who bears the tax cost of the chosen structure

The capital gains inclusion rate is one-half for 2026 (the proposed increase to two-thirds was cancelled in 2025), which feeds both the vendor's gain and the buyer's later planning.  
