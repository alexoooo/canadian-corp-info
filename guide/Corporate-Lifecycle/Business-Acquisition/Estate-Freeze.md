...
- Want to understand how a freeze fixes today's value, funds the parent's retirement, and interacts with the anti-avoidance rules

**TLDR**:
- A *freeze* swaps the current owner's growth shares for fixed-value preferred shares, and issues new common shares to the next generation
- Future growth accrues to the new common; the parent's value is locked into the preferred shares
- The corporation redeems those preferred shares over time to fund the parent's retirement, each redemption a deemed dividend
- ITA *s.84.1* blocks turning that payout into a capital gain in a family deal, with a relieving exception for genuine intergenerational transfers

Limitations:
- Orientation only; a freeze is set up by professionals, with a valuation and usually a price-adjustment clause
- The intergenerational-transfer conditions are summarized; the statute is detailed and the conditions must be met before and after closing
...
- The owner exchanges their common (growth) shares for *fixed-value, redeemable, retractable preferred shares* with a redemption value equal to the business's current worth
...
Two results follow:
- The owner's eventual capital gain is *frozen* at today's value; on death, the deemed disposition of their shares at fair market value (ITA s.70(5)) is capped at the frozen preferred-share value rather than rising with the business
- The growth, and its future tax, passes to the next generation from the moment of the freeze


## The Mechanics

A freeze is carried out with the same rollover machinery as a share-funded purchase, so the gain is deferred on the exchange:
- *Section 86*: a reorganization of capital, exchanging the old common shares for new preferred shares of the *same* corporation; no election form is required (ITA [s.86](https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-86.html))
...
Where it is still a *sole proprietorship* or *partnership*, there are no shares to exchange, so the freeze is built into the incorporation itself rather than done afterward:
- *Section 86* and the *section 85* roll to a holding corporation both exchange existing shares; an unincorporated business has none, so neither is available at this stage
...
For a *partnership*, either each partner transfers their partnership interest under s.85(1), or the partnership transfers its property under ITA [s.85(2)](https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-85.html) and is wound up under [s.85(3)](https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-85.html); each partner decides independently whether to freeze their own share.  
...
Crystallizing the LCGE therefore takes a further, deliberate step — typically a later s.85 or s.86 share exchange engineered to realize a gain on the freeze shares up to the available exemption — and whether to crystallize at all, rather than leave the exemption for a future sale, is itself a planning choice.  
...
A genuine transfer of a family business to the next generation is excepted from s.84.1, so the parent can keep capital-gains treatment and the lifetime capital gains exemption.  
The exception is in ITA s.84.1(2)(e), introduced by Bill C-208 and tightened by Budget 2023 for transfers on or after January 1, 2024.  
...
- Income Tax Act (R.S.C., 1985, c. 1 (5th Supp.)):
  ...
  - [s.85(1)](https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-85.html) - rollover to a holding corporation as an alternative freeze route, and the asset rollover that carries a freeze into a new corporation when incorporating a proprietorship or partnership
  - [s.85(2)](https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-85.html), [s.85(3)](https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-85.html) - transfer of partnership property to a corporation, and wind-up of the partnership, for a partnership freeze on incorporation
  ...
  - [s.84.1](https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-84.1.html) - anti-surplus-stripping on non-arm's-length share transfers; s.84.1(2)(e) intergenerational-transfer exception (Bill C-208, amended by Budget 2023, effective for transfers on or after January 1, 2024)
  ...
  - [s.110.6](https://laws-lois.justice.gc.ca/eng/acts/I-3.3/section-110.6.html) - lifetime capital gains exemption on QSBC shares; s.110.6(14)(f) relieves the 24-month QSBC holding period for shares issued on rolling all or substantially all of an active business into a corporation
