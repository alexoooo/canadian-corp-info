...
Where the vendors are family members, the dividends they receive, including deemed dividends on redemption, can be caught by the *Tax on Split Income* (TOSI) and taxed at the top marginal rate unless an exclusion applies (see [Dividends — TOSI](../Dividends/Dividends.md#tax-on-split-income-tosi)).  
