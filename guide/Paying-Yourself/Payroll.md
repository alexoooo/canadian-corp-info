...
- The salary-vs-dividend remuneration tradeoff (RRSP room, CPP credits, integration) is out of scope; see [Paying yourself: salary vs dividends](../Overview/Small-Business-Tax.md#paying-yourself-salary-vs-dividends)
...
- *Voucher*: CRA issues a *PD7A* (Statement of Account for Current Source Deductions) each period; remit against it through My Business Account, an online-banking payee, or a bank's business tax service (see [Payment](../Filing-And-CRA/Payment/Payment.md))
...
- Settle the boundary with [Payment](../Filing-And-CRA/Payment/Payment.md) as that page grows past the stub: this page owns the payroll concepts and bookkeeping, Payment owns the cash-to-CRA mechanics; move or trim the CPP-figure duplication accordingly
