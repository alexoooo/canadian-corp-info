...
The corp remits the GST34 net tax for each reporting period: the Quick Method flat percentage of tax-inclusive revenue for this corp, or regular-method net tax (tax collected − input tax credits). The calculation and filing are in [HST](../HST.md).

- *Account*: the `RT` program account under the business number
- *When*: an annual filer pays with the return, three months after fiscal year-end; an annual filer with prior-year net tax over $3,000 also pays *quarterly instalments* at one-quarter of the prior-year net tax, reconciled on the year-end return (ETA s.237); see [filing deadlines](../Small-Business-Tax-Overview.md#filing-deadlines-and-instalments)
...
- *Year-end*: issue a *T4* slip to the employee and file the *T4 Summary* with CRA by the last day of February; see [filing deadlines](../Small-Business-Tax-Overview.md#filing-deadlines-and-instalments)
...
The withheld amounts sit in the `Employee deductions payable` (2627) control account until remitted; see [Ledger and Accounts](../Ledger-And-Accounts.md).
