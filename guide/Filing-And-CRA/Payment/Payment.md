...
- *Instalment base*: base the instalments on the current year's estimated tax or on a prior-year instalment base
  - The canonical page sets out the one-year and two-year base methods
...
The salary-vs-dividend choice is in [Small Business Tax Overview](../../Overview/Small-Business-Tax.md#paying-yourself-salary-vs-dividends).  
