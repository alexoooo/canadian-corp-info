...
- Preparing the annual T2, paying the balance, or dealing with the CRA
...
Limitations:
- These pages assume the year's bookkeeping is already done
  - The events that feed the schedules live under [Operations](../Operations/Operations.md) and [Investments](../Investments/Investments.md)
- The following is my understanding as of 2026


## What This Covers

At year-end the year's activity comes together into the T2 return, filed, paid, and then defended if the CRA asks.  
This group covers that end of the cycle:
- [T2 Schedules](T2-Schedules.md) is the index of the return
  - Which schedule (S1, S3, S6, S7, S8, S50, S53, S55, and the rest) carries each kind of activity
  - How the schedules tie together
- [Losses](Losses.md) covers the two carryforward pools (non-capital and net capital)
  - How discretionary deductions interact with a loss year
