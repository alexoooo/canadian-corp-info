...
The 2026 Ontario budget proposes lowering the small-business rate to 2.2% (combined 11.2%) effective July 1, 2026 and the non-eligible DTC to 1.9863% effective January 1, 2027; restate for tax years straddling those dates (see [Dividends - worked examples](Dividends/Dividends-Examples.md#worked-examples)).  
