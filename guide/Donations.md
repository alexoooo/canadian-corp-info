...
- The claim is discretionary up to the cap: like losses, a donation can be banked for a year with income to absorb it — but it expires in 5 years, sooner than a non-capital loss (see [Losses](Losses.md#carrying-forward))
...
- Schedule 2 (*Charitable Donations and Gifts*) carries the continuity: gifts made, claimed, carried forward (see [T2 Schedules](T2-Schedules.md#event-driven-schedules))
...
- The *full* gain still credits the [Capital Dividend Account](Capital-Dividend-Account/Capital-Dividend-Account.md): the CDA adds the non-taxable portion of gains, which here is all of it
...
Remove the position from the [ACB tracker](Adjusted-Cost-Base/Adjusted-Cost-Base-Tracking.md) as a disposition at FMV.  
...
- *Gifts to non-qualified recipients* (a GoFundMe, a foreign charity without status, an individual): no receipt, no deduction; if the recipient is connected to the owner, the payment risks being a shareholder benefit (see [Owner-corporation transactions](Owner-Corporation-Transactions.md))
...
- [Losses](Losses.md) (the other discretionary carryforward at the taxable-income level)
- [T2 Schedules](T2-Schedules.md) (Schedule 2)
- [Expense Classification](Expense-Classification.md) (sponsorship as advertising)
