...
- The books produce the *GIFI* financial statements (S100, S125); paper financial statements are not filed — GIFI is their replacement (see [Bookkeeping, the general ledger, and GIFI](Small-Business-Tax-Overview.md#bookkeeping-the-general-ledger-and-gifi))
...
- *Identification*: name, BN, year-end, the CCPC box, and the yes/no questions — including whether specified foreign property exceeded $100,000 (which commits the corporation to a [T1135](T1135.md))
...
- *Refundable taxes*: the ERDTOH and NERDTOH continuity and the dividend refund are jacket lines, not a schedule (see [ERDTOH and NERDTOH](Dividends/ERDTOH-NERDTOH.md)); Part IV tax feeds in from S3
- *Balance*: federal and Ontario tax, minus instalments, gives the balance due or refund (see [Filing deadlines and instalments](Small-Business-Tax-Overview.md#filing-deadlines-and-instalments))
...
|---|---|---|---|
| S100 | Balance Sheet Information | always | [Ledger and Accounts](Ledger-And-Accounts.md) |
| S125 | Income Statement Information | always | [Expense Classification](Expense-Classification.md), [Ledger and Accounts](Ledger-And-Accounts.md) |
...
| S8 | Capital Cost Allowance | any depreciable property on the books | [CCA — Bookkeeping and T2 schedules](Cost-Recovery/Capital-Cost-Allowance/Capital-Cost-Allowance.md#bookkeeping-and-t2-schedules) |
| S50 | Shareholder Information | any shareholder holding 10% or more | below |
| S53 | General Rate Income Pool (GRIP) Calculation | every year, even at a zero balance | [T2 reporting — Schedule 53](Dividends/T2-Reporting.md#schedule-53---grip-calculation) |

*S1* is the spine of the tax side:
- Recurring add-backs for this guide's scenarios: book amortization (CCA replaces it), the non-deductible half of [meals](Expense-Classification.md), arrears interest and penalties (see [CRA Administration](CRA-Administration.md#booking-the-tax-cycle)), the foreign-tax add-back behind [T3 Box 34](T3/T3_Box-25-Foreign-Income_Box-34-Foreign-Tax-Withheld.md)
- Recurring deductions: CCA from S8, the non-taxable half of capital gains booked in full (see [T5008](T5008/T5008.md))
- Tax-basis books keep S1 short; that is much of their appeal (see [Ledger and Accounts](Ledger-And-Accounts.md))
...
Triggered by the corporate investment account (see [Active vs investment income](Small-Business-Tax-Overview.md#active-vs-investment-income)):

| Schedule | Title | When it applies | Details |
|---|---|---|---|
| S3 | Dividends Received, Taxable Dividends Paid, and Part IV Tax Calculation | dividends received (Part IV tax) or paid | receiving: [T5](T5/T5.md), [T3](T3/T3.md); paying: [T2 reporting — Schedule 3](Dividends/T2-Reporting.md#schedule-3---dividends-paid-section) |
| S6 | Summary of Dispositions of Capital Property | any capital disposition — securities, FX on capital account, capital gains dividends | [T5008](T5008/T5008.md), [Foreign Currency](Foreign-Currency.md), [T5 Box 18](T5/T5-Box-18-Capital-Gains-Dividends.md) |
| S7 | Aggregate Investment Income and Income Eligible for the Small Business Deduction | any investment income; splits AII from active income | [T5 — Interest Box 13](T5/T5.md#interest---box-13), [ERDTOH and NERDTOH](Dividends/ERDTOH-NERDTOH.md) |
| S21 | Federal and Provincial or Territorial Foreign Income Tax Credits | foreign withholding tax to credit | [T3 Box 25 / Box 34](T3/T3_Box-25-Foreign-Income_Box-34-Foreign-Tax-Withheld.md) |
| S55 | Part III.1 Tax on Excessive Eligible Dividend Designations | only when eligible dividends were designated beyond GRIP | [T2 reporting — Schedule 55](Dividends/T2-Reporting.md#schedule-55---part-iii1-tax-on-excessive-eligible-dividend-designations) |
...
The slip-to-schedule mapping (which T3/T5 box lands on which schedule) is diagrammed on [T5](T5/T5.md#t5-boxes) and worked box-by-box on the T3 and T5 pages.  
...
| S2 | Charitable Donations and Gifts | a donation deduction is claimed | [Donations](Donations.md) |
| S13 | Continuity of Reserves | a reserve is claimed (doubtful debts, unearned amounts) | [Receivables and Bad Debts](Receivables-And-Bad-Debts.md), [Deferred Revenue](Deferred-Revenue.md) |
| S24 | First-time Filer after Incorporation, Amalgamation, or Winding-up | the first T2 | [Starting Up](Starting-Up.md) |
| S101 | Opening Balance Sheet Information | the first T2's opening GIFI | [Starting Up — Funding the corporation](Starting-Up.md#funding-the-corporation) |
| S9 | Related and Associated Corporations | a second corporation enters the picture | [Corporate Structure](Corporate-Structure/Corporate-Structure.md) |
| S23 | Agreement Among Associated CCPCs to Allocate the Business Limit | associated CCPCs share the $500,000 limit | [Small Business Tax Overview](Small-Business-Tax-Overview.md#what-is-corporate-tax) |
| S44 | Non-Arm's Length Transactions | property acquired from a non-arm's-length person on a rollover basis (e.g. s.85) | [Starting Up — Bringing in assets](Starting-Up.md#bringing-in-assets), [Business Acquisition](Business-Acquisition/Business-Acquisition.md) |
| S11 | Transactions with Shareholders, Officers, or Employees | certain owner-corporation property transactions | [Owner-corporation transactions](Owner-Corporation-Transactions.md) |

*S2* tracks corporate donations like S4 tracks losses:
- The deduction (not a credit, at the corporate level) is capped at 75% of net income; the excess carries forward 5 years (see [Donations](Donations.md))

*S13* carries the reserve continuity year over year:
- Reserves let recognized-but-uncollected or received-but-unearned amounts defer: doubtful accounts receivable (ITA s.20(1)(l), see [Receivables and Bad Debts](Receivables-And-Bad-Debts.md)) and prepaid-but-undelivered revenue (s.20(1)(m), see [Deferred Revenue](Deferred-Revenue.md))
...
A wind-up year files the same package one last time, plus the clearance machinery around it (see [Winding Down](Winding-Down.md)).  
...
- The old Ontario annual-return schedules (S546/S547) were retired in 2021: the corporate-registry annual return is now filed in the Ontario Business Registry, separate from the T2 (see [Starting Up — First-year clocks](Starting-Up.md#first-year-clocks))
...
|---|---|---|
| S10 | Cumulative Eligible Capital Deduction | repealed regime; replaced in 2017 by CCA Class 14.1 (see [CCA Classification](Cost-Recovery/Capital-Cost-Allowance/CCA-Classification.md)) |
...
- *T1135* (Foreign Income Verification Statement): its own return with its own penalty, due with the T2; see [T1135](T1135.md)
- *T2054* (capital dividend election): filed when the dividend is elected, not with the T2; see [T2 reporting — Form T2054](Dividends/T2-Reporting.md#capital-dividend-election---form-t2054)
...
- The GIFI itself is documented in CRA guide RC4088, the source of the account names in [Ledger and Accounts](Ledger-And-Accounts.md)
...
- [Losses](Losses.md)
- [T2 reporting](Dividends/T2-Reporting.md) (S3, S53, S55 in depth)
- [ERDTOH and NERDTOH](Dividends/ERDTOH-NERDTOH.md)
- [T3](T3/T3.md), [T5](T5/T5.md), [T5008](T5008/T5008.md) (slip-to-schedule mapping)
- [T1135](T1135.md)
- [Starting Up](Starting-Up.md), [Winding Down](Winding-Down.md)
...
- Individual schedule pages are cited on the linked detail pages (S3/S53/S55 on [T2 reporting](Dividends/T2-Reporting.md), S4 on [Losses](Losses.md), S8 on [CCA](Cost-Recovery/Capital-Cost-Allowance/Capital-Cost-Allowance.md), S100/S125 on [Ledger and Accounts](Ledger-And-Accounts.md))
...
- Confirm the jacket's yes/no question line numbers (the T1135 question in particular, coordinating with the [T1135](T1135.md) TODO)
