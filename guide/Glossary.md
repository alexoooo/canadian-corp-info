...
- Capitalization policy: a corporation's *de minimis* floor (commonly $500, up to $2,500, applied consistently) below which a long-lived item is expensed immediately rather than capitalized and depreciated; a bookkeeping convention, not a CRA rule; see [Capital-Cost-Allowance.md](Cost-Recovery/Capital-Cost-Allowance.md#capitalize-vs-expense-thresholds)
