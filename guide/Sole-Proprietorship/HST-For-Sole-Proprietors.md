...
- The Quick Method is open to individuals on the same terms; mixed-use inputs earn ITCs only at the business-use share

Limitations:
- This is a delta page: the mechanics live on the corporate [HST pages](../Operations/HST/HST.md) and are not restated
- PST and QST are out of scope, as on the corporate pages
...
## Ride-Share and Taxi: No Threshold

The small-supplier threshold does not apply to a *taxi business* (ETA [s.240(1.1)](https://laws-lois.justice.gc.ca/eng/acts/E-15/section-240.html)):
- Registration is mandatory from the first fare, in respect of that business
- The [s.123(1)](https://laws-lois.justice.gc.ca/eng/acts/E-15/section-123.html) *taxi business* definition reaches passenger transport arranged through an electronic platform
  - That is commercial ride-share driving; sightseeing services and school transportation are excluded

This is the gig case the threshold surprises most: a part-time driver is a registrant regardless of revenue.  


## Quick Method as an Individual
...
Under the regular method, a mixed business-and-personal input earns an ITC only at the business-use share:
- The home-office share of utilities, the business share of phone, internet, and vehicle running costs
- The personal share earns no ITC
- Claiming the ITC means recording the expense net of the recovered tax on the [T2125](T2125-And-Expenses.md)

The documentation is the same log-and-proportion evidence backing the income-tax claim.  
Passenger-vehicle ITCs carry their own caps, tied to the income-tax ceilings; see [HST Regular Method](../Operations/HST/HST-Regular-Method.md).  
...
- [GST/HST](../Operations/HST/HST.md) (the corporate hub these pages delta from)
- [HST Registration and Filing](../Operations/HST/HST-Registration-And-Filing.md)
- [HST Quick Method](../Operations/HST/HST-Quick-Method.md)
- [Becoming a Sole Proprietor](Becoming-A-Sole-Proprietor.md) (the BN and program accounts)
- [T2125 and Expenses](T2125-And-Expenses.md) (the income-tax side of the same inputs)
- [CPP and the T1](CPP-And-The-T1.md) (the parallel T1 instalments)
...
- Work out the interaction between mandatory taxi-business registration and small-supplier status in other activities
- Confirm whether an individual opens the `RT` account through My Business Account or only through BRO
