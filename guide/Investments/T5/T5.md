...
- Box 27: foreign-currency indicator (e.g. USD); not income, but it tells you the boxes are stated in a foreign currency and must be converted to CAD; see [Foreign Currency](../../Bookkeeping/Foreign-Currency/Foreign-Currency.md)
...
It is the T5 analogue of T3 Box 26; for the AII classification, the NERDTOH link, and the SBD grind over $50,000 of AAII, see [T3 - Box 26 Other Income](../T3/T3-Box-26-Other-Income.md).  
...
Schedule 7 (S7) / Part 1 / Box 032 - worldwide income from property: enter the full gross Box 15 amount; this feeds aggregate investment income (line 092 → T2 line 440) and is the entry most easily missed.  
Schedule 7 (S7) / Part 3 / Box 019 - foreign-source income from property (net of related expenses): enter the same gross Box 15 amount (the foreign subset → line 445).  
...
- On a broker-issued T5, the foreign income in Box 15 is not necessarily a dividend; directly held foreign bonds or T-bills produce foreign *interest*
...
If Box 27 shows a foreign currency, convert each box to CAD at the payment-date rate before posting; see [Foreign Currency](../../Bookkeeping/Foreign-Currency/Foreign-Currency.md).  
...
→ S6 reports a $500 gain; taxable half $250 → S1 line 113 (auto) and AII; S1 line 395 deduction = $500 (the full amount booked to 8211-3); CDA += $250  
