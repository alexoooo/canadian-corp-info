...
Schedule entries:
- Schedule 7 (S7) / Part 1 / Box 032 (worldwide income from property): enter the full gross Box 15 amount
  - Feeds aggregate investment income (line 092 → T2 line 440); the entry most easily missed
- S7 / Part 3 / Box 019 (foreign-source income from property, net of related expenses): the same gross Box 15 amount
