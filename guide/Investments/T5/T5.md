...
- S7 / Part 3 / Box 019 (foreign-source income from property, net of related expenses): the same net figure
  ...
  - Where costs are attributable (counsel fees on the holding, interest on money borrowed to buy it), allocate them
    by source and file the net amount
  - Keep those booked expenses in Schedule 125; Schedule 7 classifies income rather than deducting them again
  - Do not claim an additional Schedule 1 deduction for an expense already deducted in book income
