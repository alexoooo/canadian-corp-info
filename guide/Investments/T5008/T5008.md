...
- Box 21: Proceeds of disposition or settlement amount
  ...
  - If you see the gross amount (and the trade confirmation has a commission), subtract the commission
    - The commission belongs in Schedule 6 (S6) as "Outlays and expenses from disposition", not folded into Box 21
...
Translate the proceeds at the trade-date rate (a settlement-date rate is also defensible).  
