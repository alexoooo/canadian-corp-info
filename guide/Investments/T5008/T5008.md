...
Use line 401 (Gain on disposal of assets per financial statements).  
Or equivalently an Other-deductions entry (description 705 / amount 395) at the full amount.  
Taxable income then reflects only the 50% inclusion.  
Backing out only the non-taxable half would double-count once line 113 is filled.  
