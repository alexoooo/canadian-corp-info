...
A capital gain is only half taxable: Schedule 6 reports the full gain and carries the taxable half to the T2's income.  
Because the ledger entry above books the whole gain, Schedule 1 then backs out the non-taxable half (the deduction at Schedule 1 description 705 / amount 395), so taxable income reflects only the 50% inclusion.  
