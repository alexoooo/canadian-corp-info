...
- For a vanilla index ETF that is structured as a mutual fund trust:
  ...
  - The portion of Part I tax on AII that flows into NERDTOH (30⅔% of AII per s.129(4)) is recovered only when the corporation pays a non-eligible dividend; see [ERDTOH-NERDTOH.md](../Dividends/ERDTOH-NERDTOH.md) for refund mechanics
